<template>
  <q-layout view="lHh Lpr lFf">
    ...
    <q-page-container>
      <router-view @update-menu="handleUpdateMenu" v-slot="{ Component }">
...
let defaultList = [
  {
    ...
    menuitems: [
      ...
      },
      {
        ...
        caption: "usermessagingsetup",
        icon: "key",
        link: "/usermessagingseup",
      },
      {
      ...
      /*
      {
       ...
       {
        title: ' Validate User Dynamic Authentication',
        icon: 'key',
        link: '/validatedan',
      },
...
function loadUserImage(email) {
  ...
  const promise = axios.get(path.USER_IMAGE, requestParam, headers);
  promise
    .then((response) => {
