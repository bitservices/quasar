...
const path = {
  ...
  PRODUCTDEF_SUBSCRIPTION_FORM:
    APP_PATH + "productdef/getProductTypeDefSubscription/",
  ...
  USRS_OUTSTANDING_PAYMENT_CREATE:
    APP_PATH + "useroutstanding/generateMembersOutStandingPayment/",
  USR_OUTSTANDING_PAYMENT_SEARCH_GROUP_BY_ORGANISATION:
    APP_PATH + "useroutstanding/findbyuser/",
  USR_OUTSTANDING_PAYMENTS_GENERATE:
    APP_PATH + "useroutstanding/generateOutstandingPaymentsForMembers/",
  ...
  VENDOR_PAYMENT_TRANSACTION_REPORT:
    APP_PATH + "report/vendortransactionreport/",

  VENDOR_LEDGER_PAYMENT_TRANSACTION_SEARCH: APP_PATH + "vendorledger/search/",
  VENDOR_LEDGER_PAYMENT_TRANSACTION_REPORT:
    APP_PATH + "report/vendorledgerreport/",

  SELF_VENDOR_PAYMENT_TRANSACTION_SEARCH:
    APP_PATH + "vendorpayment/selfServiceIncome/",
  SELF_VENDOR_PAYMENT_TRANSACTION_REPORT:
    APP_PATH + "report/selfServiceIncomeReport/",
  ...
  SEND_BIRTHDATY_MESSAGE:
    APP_PATH + "msgingstup/runBirthDayMessageToMembersByCordinators/",
  ...
  USER_MESSAGINGSETUP_CREATE: APP_PATH + "usermessagingsetup/create/",
  USER_MESSAGINGSETUP_SEARCH: APP_PATH + "usermessagingsetup/search/",
  USER_MESSAGINGSETUP_UPDATE: APP_PATH + "usermessagingsetup/update/",
  USER_MESSAGINGSETUP_DELETE: APP_PATH + "usermessagingsetup/delete/",
  USER_MESSAGINGSETUP_REMOVE: APP_PATH + "usermessagingsetup/remove/",
  ...
  SUBSCRIPTION_PMT_RECEIPT: APP_PATH + "subscriptionpayment/generatereceipt/",
  ...
  RUN_CRON_JOBS: APP_PATH + "clientsmtpconfig/executeCronJobs/",
};
